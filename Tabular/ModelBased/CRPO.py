...
"""
CRPO: constraint rectified policy optimization, primal approach to learn safe policy
"""
...
def run_CRPO_agent(cmdp, optimal_performance, num_iterations, output_dir, moving_avg_window,
                   full_average, initial_policy, eta, learning_rate):
...
if __name__ == '__main__':
    ...
    fold_name = os.path.join(save_dir_loc, "Results/Tabular/CRPO/ModelBased")
