...
python $path_name$file_name --learning_rate_pol $lrp --learning_rate_lambd $lrl_val --num_iterations $iters --run $run --num_samples $sample --gamma $gam --b_thresh $b_thresh
