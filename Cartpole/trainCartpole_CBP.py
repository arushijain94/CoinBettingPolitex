from CBP import CB_Primal, CB_Dual
...
def run_CB_agent(cmdp, num_iterations, output_dir, ub_lambd, alpha_lambd, num_samples, entropy_coeff, feature, seed,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_iterations', help="iterations", type=int, default=2)
